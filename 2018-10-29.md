...
```Powershell
Ni -ItemType directory usuario1,usuario2
```
...
```Powershell
Cd .\usuario1
Sc .\fichero.txt -value "contenido"
Cd ..
Cd .\usuario2
Sc .\fichero2.txt -value "contenido2"
```
...
```Powershell
Rni -Path .\usuario2 -NewName "usuario100" -Force
```
---------------------
- Mover archivos de una carpeta a otra
```Powershell
Mi .\fichero.txt -Destination .\usuario1
```
